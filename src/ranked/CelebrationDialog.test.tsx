...
/** The body is split across <strong> tags, so match on the paragraph's full text content. */
const bodyText = (text: string) =>
  screen.getByText((_content, el) => el?.tagName === 'P' && el.textContent === text);
...
describe('CelebrationDialog', () => {
  ...
  it('shows the board copy and opens the run’s board for a top-ten place', () => {
    ...
    expect(bodyText("A streak of 20 puts you at #4. The podium's in sight.")).toBeTruthy();
